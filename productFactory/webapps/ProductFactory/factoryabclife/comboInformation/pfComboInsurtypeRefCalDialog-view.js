...
unieap.define("pfComboInsurtypeRefCalDialog", function () {
    ...
    dojo.declare("_factoryabclife.comboInformation.pfComboInsurtypeRefCalDialog.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.comboInformation.pfComboInsurtypeRefCalDialog.Processor(this);
    ...
    var view = new _factoryabclife.comboInformation.pfComboInsurtypeRefCalDialog.View();
    view.init();
