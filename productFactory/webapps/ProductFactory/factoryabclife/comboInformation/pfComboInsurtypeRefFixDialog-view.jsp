...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboInsurtypeRefFixDialog-processor.js?version=20161130135530"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboInsurtypeRefFixDialog-view.js?version=20161130135530"></script>
            ...
            <tbody>
                <tr id='form_fix_0_tr'>
                    ...
                    <td colSpan='1' id='fixVal_td' rowSpan='1'>
                        <div dojoType='unieap.form.ComboBox' id='fixVal' maxLength='16' required='true' width='100%' binding="{name:'fixVal'}" decoder="{displayAttr:'paramDesc',valueAttr:'paramUnit'}" popup="{height:'200px'}"></div>
                    </td>
                    <td>
                    </td>
                </tr>
