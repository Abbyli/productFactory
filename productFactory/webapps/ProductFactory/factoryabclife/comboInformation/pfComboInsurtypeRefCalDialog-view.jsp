...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboInsurtypeRefCalDialog-processor.js?version=20161130094120"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboInsurtypeRefCalDialog-view.js?version=20161130094120"></script>
