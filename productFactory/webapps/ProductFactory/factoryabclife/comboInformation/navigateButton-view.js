...
unieap.define(navigateButtonContext, function () {
    ...
    dojo.declare("_factoryabclife.comboInformation.navigateButton.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.comboInformation.navigateButton.Processor(this);
    ...
    function comboAttr_onClick(event) {
        ...
        var newDC = view.prepareDCParameter();
        view.backToRiskConfig(navigatorContainer);
        view.navigator.forward("ProductFactory", "factoryabclife", "comboInformation/pfComboAttrib", "组合属性", newDC);
    }
    ...
    function comboElement_onClick(event) {
        ...
        var newDC = view.prepareDCParameter();
        view.backToRiskConfig(navigatorContainer);
        view.navigator.forward("ProductFactory", "factoryabclife", "comboInformation/pfComboElement", "组合要素定义", newDC);
    }
    ...
    function elementRef_onClick(event) {
        ...
        var newDC = view.prepareDCParameter();
        view.backToRiskConfig(navigatorContainer);
        view.navigator.forward("ProductFactory", "factoryabclife", "comboInformation/pfComboInsurtypeRef", "险种要素关系", newDC);
    }
    ...
    function comboRateManage_onClick(event) {
        ...
        var newDC = view.prepareDCParameter();
        view.backToRiskConfig(navigatorContainer);
        view.navigator.forward("ProductFactory", "factoryabclife", "comboInformation/pfComboRateManage", "组合精算数据定义", newDC);
    }

    var view = new _factoryabclife.comboInformation.navigateButton.View();
    view.init();
