...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboElement-processor.js?version=20161227161000"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboElement-view.js?version=20161227161000"></script>
...
pfComboElement.page_initEvents&&dojo.hitch(pfComboElement,pfComboElement.page_initEvents)();
    ...
    <div dojoType='unieap.xdialog.Dialog' height='450px' id='xdialog1' title='XDialog' url='<%=path%>/ProductFactory/factoryabclife/comboInformation_pfComboElementDialog_entry.action' width='680px'>
    </div>
</s:i18n>
    </security:auth>
	</body>
