...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboRateManage-processor.js?version=20161227162232"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/comboInformation/pfComboRateManage-view.js?version=20161227162232"></script>
                ...
                <div dojoType='unieap.layout.AdaptivePane' autoHeight='true' id='adaptivePane2'>
                    <div dojoType='unieap.layout.TitlePane' flexible='false' height='100%' id='titlePane2' title='组合精算数据' width='100%'>
                        ...
                        <div dojoType='unieap.xgrid.Grid' height='100%' id='grid_comboRateManage' binding="{store:'tObjRate_combo'}" selection="{selectType:'single'}" views="{rowBar:true,rowNumber:true}">
                            ...
                            <header>
                                <row>
                                    <cell dataType='string' enable='false' id='cell_rateType' label='费率类型' name='rateType' width='50%' decoder="{store:'ds_dimension'}"></cell>
                                    <cell dataType='string' enable='false' id='cell_tableName' label='表名称' name='tableName' width='50%'></cell>
                                </row>
                            </header>
                        </div>
                    </div>
