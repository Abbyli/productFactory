...
unieap.define("pfRiskElement", function () {
    ...
    dojo.addOnLoad(function () {
        navigateButton = pfRiskElement_navigateButton;
    });
    dojo.addOnLoad(function () {

    });

    dojo.declare("_factoryabclife.risk.pfRiskElement.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.risk.pfRiskElement.Processor(this);
        ...
        page_load: function () {
            ...
            view.navigator.receiveData("定价责任要素定义", function (dc) {
                var tInsurtypeBasicInf = dc.getDataStore("tInsurtypeBasicInf");
                var duty = dc.getDataStore("duty");
                dutyId = duty.rowSet.primary[0].pricingLiabId;
            ...
            view.navigator.onComplete("定价要素属性", function (dc) {
    ...
    function update(inRowIndex) {
        ...
        view.navigator.forward("ProductFactory", "factoryabclife", "risk/pfRiskElementShow", "定价要素属性", newDC);
    }
    ...
    function cell_control_element_formatter(inValue, inRowIndex) {
        ...
        var updateBtn = "<img src='" + editImg + "' " +
            ...
            "onclick=\"pfRiskElement.update('" + inRowIndex + "')\" />";

        var delBtn = "<img src='" + delImg + "' " +
            "style=\"cursor:pointer\" title=\"删除\" " +
            "onclick=\"pfRiskElement.del('" + inRowIndex + "')\" />";
    ...
    var view = new _factoryabclife.risk.pfRiskElement.View();
    view.init();
