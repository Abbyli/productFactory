...
unieap.define("pfRiskPrestElementShow", function () {
    ...
    dojo.addOnLoad(function () {
        navigateButton = pfRiskPrestElementShow_navigateButton;
    });
    dojo.addOnLoad(function () {

    });

    dojo.declare("_factoryabclife.risk.pfRiskPrestElementShow.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.risk.pfRiskPrestElementShow.Processor(this);
        ...
        page_load: function () {
            ...
            view.navigator.receiveData("保障要素属性", function (dc) {
        ...
        if (info == "") {
            MessageBox.autoCloseAlert({
                ...
                onComplete: function () {
                    ...
                    view.navigator.prePage("保障要素属性", dc);
                }
            });
        }
        else {
    ...
    function getPfSKElementSuccess(dc) {
        unieap.byId("name_element")
            .getDataProvider().setDataStore(dc.getDataStore("getPrestTSkelementDef"));
    }
    /**
    ...
    var view = new _factoryabclife.risk.pfRiskPrestElementShow.View();
    view.init();
