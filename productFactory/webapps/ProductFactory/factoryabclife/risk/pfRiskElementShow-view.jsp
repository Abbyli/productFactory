...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/risk/pfRiskElementShow-processor.js?version=20170329114504"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/risk/pfRiskElementShow-view.js?version=20170329114504"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				pfRiskElementShow_navigateButton.setViewcContext("pfRiskElementShow_navigateButton");
pfRiskElementShow_navigateButton.page_initEvents&&dojo.hitch(pfRiskElementShow_navigateButton,pfRiskElementShow_navigateButton.page_initEvents)();
pfRiskElementShow_navigateButton.page_load&&dojo.hitch(pfRiskElementShow_navigateButton,pfRiskElementShow_navigateButton.page_load)();
pfRiskElementShow.page_initEvents&&dojo.hitch(pfRiskElementShow,pfRiskElementShow.page_initEvents)();
				pfRiskElementShow.page_load&&dojo.hitch(pfRiskElementShow,pfRiskElementShow.page_load)();
    ...
    <div dojoType='unieap.layout.BorderContainer' design='headline' id='borderLayout1' showTitleBar='false'>
        <div dojoType='unieap.layout.BorderPane' id='borderPane0' region='left' showTitleBar='false' splitLine='false'>
            <jsp:include page='/ProductFactory/factoryabclife/risk/navigateButton-view.jsp'>
                <jsp:param name="viewcContext" value="pfRiskElementShow" /></jsp:include>
        </div>
