...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboChoose-processor.js?version=20170110150501"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboChoose-view.js?version=20170110150501"></script>
...
pfComboChoose.page_initEvents&&dojo.hitch(pfComboChoose,pfComboChoose.page_initEvents)();
                ...
                <div dojoType='unieap.layout.AdaptivePane' autoHeight='true' id='adaptivePane2'>
                    <div dojoType='unieap.layout.TitlePane' flexible='false' height='100%' id='titlePane2' title='组合列表' width='100%'>
                        <div id='div1' type='buttons'>
                            <div dojoType='unieap.form.Button' class='titlePane-button' id='button1' label='添加险种' width='100px'></div>
                        </div>
                        <div dojoType='unieap.xgrid.Grid' height='100%' id='grid_insurtype' binding="{store:'tComboInsurtype_grid',rpc:pfComboChoose.grid_insurtype_binding_rpc}" selection="{selectType:'none'}" views="{rowBar:false,rowNumber:true}">
                            ...
                            <header>
                                <row>
                                    <cell dataType='string' enable='false' id='cell_insurtypeName' label='险种名称' name='insurtypeName' width='15%' decoder="{store:'INSURTYPE_NAME'}"></cell>
                                    ...
                                    <cell dataType='string' enable='false' id='cell_pricingName' label='定价名称' name='pricingName' width='15%'></cell>
                                    <cell enable='false' id='cell_control' label='操作' name='control' width='10%' formatter='pfComboChoose.cell_control_formatter'></cell>
                                </row>
                            </header>
                        </div>
                    </div>
    ...
    <div dojoType='unieap.xdialog.Dialog' height='180px' id='insurtypeDialog' title='选择险种' url='<%=path%>/ProductFactory/factoryabclife/combo_pfComboChooseDialog_entry.action' width='680px'>
    </div>
</s:i18n>
    </security:auth>
	</body>
