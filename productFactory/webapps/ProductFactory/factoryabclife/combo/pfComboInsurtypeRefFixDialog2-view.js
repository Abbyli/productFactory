...
unieap.define("pfComboInsurtypeRefFixDialog2", function () {
    ...
    dojo.declare("_factoryabclife.combo.pfComboInsurtypeRefFixDialog2.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.combo.pfComboInsurtypeRefFixDialog2.Processor(this);
    ...
    var view = new _factoryabclife.combo.pfComboInsurtypeRefFixDialog2.View();
    view.init();
