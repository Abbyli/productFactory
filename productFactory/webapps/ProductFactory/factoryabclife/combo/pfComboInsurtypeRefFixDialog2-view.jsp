...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboInsurtypeRefFixDialog2-processor.js?version=20161130094241"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboInsurtypeRefFixDialog2-view.js?version=20161130094241"></script>
