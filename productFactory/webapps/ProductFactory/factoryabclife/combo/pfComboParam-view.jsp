...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboParam-processor.js?version=20161117152253"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboParam-view.js?version=20161117152253"></script>
                        ...
                        <div dojoType='unieap.layout.ContentPane' id='tabPane1' title='保险期间'>
                            <div dojoType='unieap.layout.TitlePane' flexible='false' height='100%' id='titlePane2' width='100%'>
                                <div id='div1' type='buttons'>
                                    <div dojoType='unieap.form.Button' class='titlePane-button' id='save1' label='保&nbsp;存' width='100px'></div>
                                </div>
                                <div dojoType='unieap.xgrid.Grid' height='100%' id='grid_insur' binding="{store:'tProductParamDef_grid_insur'}" selection="{selectType:'multiple'}" views="{rowBar:true,rowNumber:true}">
                        ...
                        <div dojoType='unieap.layout.ContentPane' id='tabPane2' title='交费期间'>
                            <div dojoType='unieap.layout.TitlePane' flexible='false' height='100%' id='titlePane3' width='100%'>
                                <div id='div2' type='buttons'>
                                    <div dojoType='unieap.form.Button' class='titlePane-button' id='save2' label='保&nbsp;存' width='100px'></div>
                                </div>
                                <div dojoType='unieap.xgrid.Grid' height='100%' id='grid_payEnd' binding="{store:'tProductParamDef_grid_payEnd'}" selection="{selectType:'multiple'}" views="{rowBar:true,rowNumber:true}">
                                    <toolbar>
                                    </toolbar>
                                    <header>
                                        <row>
                        ...
                        <div dojoType='unieap.layout.ContentPane' id='tabPane3' title='交费频率'>
                            <div dojoType='unieap.layout.TitlePane' flexible='false' height='100%' id='titlePane4' width='100%'>
                                <div id='div3' type='buttons'>
                                    <div dojoType='unieap.form.Button' class='titlePane-button' id='save3' label='保&nbsp;存' width='100px'></div>
                                </div>
                                <div dojoType='unieap.form.CheckBoxGroup' cols='10' id='checkBoxGroup1' labelAlign='right' width='100%' dataProvider="{store:'ds_freq'}"></div>
                            </div>
                        </div>
                    </div>
                </div>
