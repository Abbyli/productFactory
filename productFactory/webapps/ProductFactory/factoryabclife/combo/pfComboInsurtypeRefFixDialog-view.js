...
unieap.define("pfComboInsurtypeRefFixDialog", function () {
    ...
    dojo.declare("_factoryabclife.combo.pfComboInsurtypeRefFixDialog.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.combo.pfComboInsurtypeRefFixDialog.Processor(this);
    ...
    var view = new _factoryabclife.combo.pfComboInsurtypeRefFixDialog.View();
    view.init();
