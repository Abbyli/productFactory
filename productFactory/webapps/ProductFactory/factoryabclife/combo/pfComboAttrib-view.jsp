...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboAttrib-processor.js?version=20170328103443"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboAttrib-view.js?version=20170328103443"></script>
                        ...
                        <tbody>
                            <tr id='form_attrib_1_tr'>
                                ...
                                <td colSpan='1' id='comboSalesWay_td' rowSpan='1'>
                                    <div dojoType='unieap.form.ComboBox' id='comboSalesWay' maxLength='2' required='true' width='100%' binding="{name:'comboSalesWay'}" dataProvider="{store:'ds_saleWay'}"></div>
                                </td>
                                <td align='center' colSpan='2' id='isByCopiesSales_label_td' rowSpan='1'>
                                    <div dojoType='unieap.form.CheckBoxGroup' cols='2' id='checkBoxGroup1' labelAlign='right' width='80%'></div>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr id='form_attrib_3_tr'>
                                ...
                                <td colSpan='1' id='isHaveIndependRate_td' rowSpan='1'>
                                    <div dojoType='unieap.form.ComboBox' id='isHaveIndependRate' maxLength='1' required='true' width='100%' binding="{name:'isHaveIndependRate'}" dataProvider="{store:'ds_YON'}"></div>
                                </td>
                                <td align='right' id='premAlgoId_label_td' rowSpan='1'>
                                    <label id='isByCopiesSales_label' style='display:none'>是否按份数销售：</label>
                                </td>
                                <td colSpan='1' id='premAlgoId_td' rowSpan='1'>
                                    <div dojoType='unieap.form.ComboBox' id='isByCopiesSales' maxLength='1' width='100%' style='display:none' binding="{name:'isByCopiesSales'}" dataProvider="{store:'ds_YON'}"></div>
                                </td>
                                <td>
                                </td>
                            </tr>
                            ...
                            <tr id='form_attrib_6_tr'>
                                <td align='right' id='unitSuminsur_label_td' rowSpan='1'>
                                    <label id='isPermitAutoPay_label'>是否允许自垫：</label>
                                </td>
                                <td colSpan='1' id='unitSuminsur_td' rowSpan='1'>
                                    <div dojoType='unieap.form.ComboBox' id='isPermitAutoPay' required='true' width='100%' binding="{name:'isPermitAutoPay'}" dataProvider="{store:'ds_YON'}"></div>
                                </td>
                                <td align='right'>
                                    <label id='isPermitInsurRenew_label'>是否允许续保：</label>
                                </td>
                                <td>
                                    <div dojoType='unieap.form.ComboBox' id='isPermitInsurRenew' required='true' width='100%' binding="{name:'isPermitInsurRenew'}" dataProvider="{store:'ds_YON'}"></div>
                                </td>
                                <td>
                                </td>
                            </tr>
