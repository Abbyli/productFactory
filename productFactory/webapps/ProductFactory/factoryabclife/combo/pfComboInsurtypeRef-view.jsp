...
<%--
    ...
    @modificationTime 2016-11-23 15:36:47
    @version 1.0.0 
--%>
...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboInsurtypeRef-processor.js?version=20161123153647"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/pfComboInsurtypeRef-view.js?version=20161123153647"></script>
...
pfComboInsurtypeRef.page_initEvents&&dojo.hitch(pfComboInsurtypeRef,pfComboInsurtypeRef.page_initEvents)();
    ...
    <div dojoType='unieap.xdialog.Dialog' height='300px' id='xdialog1' title='设置算法' url='<%=path%>/ProductFactory/factoryabclife/combo_pfComboInsurtypeRefCalDialog_entry.action' width='680px'>
    </div>
    <div dojoType='unieap.xdialog.Dialog' height='120px' id='xdialog2' title='设置固定值' url='<%=path%>/ProductFactory/factoryabclife/combo_pfComboInsurtypeRefFixDialog_entry.action' width='680px'>
    </div>
    <div dojoType='unieap.xdialog.Dialog' height='120px' id='xdialog3' title='设置固定值' url='<%=path%>/ProductFactory/factoryabclife/combo_pfComboInsurtypeRefFixDialog2_entry.action' width='680px'>
    </div>
</s:i18n>
    </security:auth>
	</body>
