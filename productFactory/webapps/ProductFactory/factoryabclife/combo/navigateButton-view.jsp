...
<%@ taglib prefix="s" uri="/struts-tags" %>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/ProductFactory/factoryabclife/combo/navigateButton-processor.js?version=20161207150547"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/ProductFactory/factoryabclife/combo/navigateButton-view.js?version=20161207150547"></script>
