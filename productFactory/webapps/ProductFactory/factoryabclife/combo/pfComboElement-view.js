...
unieap.define("pfComboElement", function () {
    ...
    dojo.declare("_factoryabclife.combo.pfComboElement.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.combo.pfComboElement.Processor(this);
    ...
    function cell_control_formatter(inValue, inRowIndex) {
        ...
        var delBtn = "<img src='" + delImg + "' " +
            ...
            "onclick=\"pfComboElement.del('" + inRowIndex + "')\" />";
    ...
    var view = new _factoryabclife.combo.pfComboElement.View();
    view.init();
