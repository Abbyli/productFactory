...
unieap.define("pfComboInsurtypeRef", function () {
    ...
    dojo.declare("_factoryabclife.combo.pfComboInsurtypeRef.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.combo.pfComboInsurtypeRef.Processor(this);
    ...
    var view = new _factoryabclife.combo.pfComboInsurtypeRef.View();
    view.init();
