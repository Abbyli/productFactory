...
unieap.define("pfComboElementDialog", function () {
    ...
    dojo.declare("_factoryabclife.combo.pfComboElementDialog.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _factoryabclife.combo.pfComboElementDialog.Processor(this);
    ...
    var view = new _factoryabclife.combo.pfComboElementDialog.View();
    view.init();
