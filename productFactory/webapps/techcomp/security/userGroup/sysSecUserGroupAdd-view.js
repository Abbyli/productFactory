...
unieap.define("sysSecUserGroupAdd", function () {

    dojo.addOnLoad(function () {

    });

    dojo.declare("_security.userGroup.sysSecUserGroupAdd.View", unieap.view.View, {
        ...
        create: function () {
            ...
            dojo.mixin(this, {
                ...
                addUserGroupSuccess: addUserGroupSuccess,
                form1_saveButton_onClick: form1_saveButton_onClick,
                form1_resetButton_onClick: form1_resetButton_onClick
            });

            this.processor = new _security.userGroup.sysSecUserGroupAdd.Processor(this);
    ...
    function addUserGroupSuccess(dc) {
    ...
    var view = new _security.userGroup.sysSecUserGroupAdd.View();
    view.init();
