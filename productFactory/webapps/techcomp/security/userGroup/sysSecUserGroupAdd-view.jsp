...
<%--
    ...
    @author dongyw
    @creationTime 2014-07-03 09:05:05
    @modificationTime 2014-08-15 13:08:14
    @version 1.0.0 
--%>
...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/userGroup/sysSecUserGroupAdd-processor.js?version=20140815130814"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/userGroup/sysSecUserGroupAdd-view.js?version=20140815130814"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				sysSecUserGroupAdd.page_initEvents&&dojo.hitch(sysSecUserGroupAdd,sysSecUserGroupAdd.page_initEvents)();
				sysSecUserGroupAdd.page_load&&dojo.hitch(sysSecUserGroupAdd,sysSecUserGroupAdd.page_load)();
