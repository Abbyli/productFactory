...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/role/sysSecRoleEdit-processor.js?version=20140813191636"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/role/sysSecRoleEdit-view.js?version=20140813191636"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				sysSecRoleEdit.page_initEvents&&dojo.hitch(sysSecRoleEdit,sysSecRoleEdit.page_initEvents)();
				sysSecRoleEdit.page_load&&dojo.hitch(sysSecRoleEdit,sysSecRoleEdit.page_load)();
