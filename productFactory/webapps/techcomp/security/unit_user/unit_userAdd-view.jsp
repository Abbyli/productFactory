...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/unit_user/unit_userAdd-processor.js?version=20141231144316"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/unit_user/unit_userAdd-view.js?version=20141231144316"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				unit_userAdd.page_initEvents&&dojo.hitch(unit_userAdd,unit_userAdd.page_initEvents)();
				unit_userAdd.page_load&&dojo.hitch(unit_userAdd,unit_userAdd.page_load)();
    ...
    <div dojoType='unieap.layout.BorderContainer' design='headline' id='borderLayout1' showTitleBar='false'>
            ...
            <table id='ToolBar1' width='100%' style='table-layout:fixed;'>
                ...
                <tbody>
                    <tr height='30px'>
                        ...
                        <td align='center'>
                            <div dojoType='unieap.form.Button' height='25px' iconClass='buttonSepSave' id='saveButton' label='保存' width='90px'></div>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div dojoType='unieap.layout.BorderPane' id='borderPane1' region='center' showTitleBar='false' splitLine='false'>
                    ...
                    <tbody>
                        <tr height='50px' id='form1_1_tr'>
                            <td align='right' id='name_label_td' rowSpan='1'>
                                <label id='name_label'>人员姓名（全模糊）：</label>
                            </td>
                            ...
                            <td align='right' id='account_label_td' rowSpan='1'>
                                <label id='account_label'>账号（全模糊）：</label>
                            </td>
            ...
            <div dojoType='unieap.layout.TitlePane' flexible='false' id='grid1_titlePane_qResult' title='人员列表'>
                <div dojoType='unieap.xgrid.Grid' height='365px' id='grid1' binding="{store:'sysSecUser',rpc:unit_userAdd.grid1_binding_rpc}" selection="{selectType:'multiple',onAfterSelect:unit_userAdd.grid1_selection_onAfterSelect,onAfterDeselect:unit_userAdd.grid1_selection_onAfterDeselect,onBeforeAllSelect:unit_userAdd.grid1_selection_onBeforeAllSelect}"
                views="{rowBar:true,rowNumber:true}">
                    ...
                    <header>
                        <row>
                            ...
                            <cell dataType='string' enable='false' id='cell_description' label='描述' name='description' width='50%'></cell>
                            <cell dataType='string' enable='false' id='cell_accountEnabled' label='是否可用' name='accountEnabled' width='10%'></cell>
                        </row>
                    </header>
                </div>
            </div>
