...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/datasource/sysSecDataSourceEdit-processor.js?version=20140815101235"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/datasource/sysSecDataSourceEdit-view.js?version=20140815101235"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				sysSecDataSourceEdit.page_initEvents&&dojo.hitch(sysSecDataSourceEdit,sysSecDataSourceEdit.page_initEvents)();
				sysSecDataSourceEdit.page_load&&dojo.hitch(sysSecDataSourceEdit,sysSecDataSourceEdit.page_load)();
