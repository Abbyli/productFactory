...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/user/sysSecUserEdit-processor.js?version=20140924155435"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/user/sysSecUserEdit-view.js?version=20140924155435"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				sysSecUserEdit.page_initEvents&&dojo.hitch(sysSecUserEdit,sysSecUserEdit.page_initEvents)();
				sysSecUserEdit.page_load&&dojo.hitch(sysSecUserEdit,sysSecUserEdit.page_load)();
            ...
            <tbody>
                ...
                <tr height='30px' id='form1_3_tr'>
                    ...
                    <td colSpan='1' height='40px' id='birthdate_td' rowSpan='1'>
                        <div dojoType='unieap.form.DateTextBox' id='birthdate' width='100%' binding="{name:'birthdate'}"></div>
                    </td>
                </tr>
                <tr height='30px' id='form1_5_tr'>
                    ...
                    <td colSpan='1' height='40px' id='officeTelephone_td' rowSpan='1'>
                        <div dojoType='unieap.form.TextBox' id='officeTelephone' maxLength='32' width='100%' binding="{name:'officeTelephone'}" inputFilter="{filterRule:/(^[0-9]{3,4}\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)|(^0{0,1}1[0-9]{10}$)/}"></div>
                    </td>
                </tr>
                <tr height='30px' id='form1_7_tr'>
                    ...
                    <td colSpan='1' height='40px' id='code_td' rowSpan='1'>
                        <div dojoType='unieap.form.TextBox' id='code' maxLength='8' minLength='8' required='true' width='100%' binding="{name:'code'}" inputFilter="{filterRule:/^[a-zA-Z0-9._-]+$/}"></div>
                    </td>
                ...
                <tr height='30px' id='form1_11_tr'>
                    ...
                    <td colSpan='1' height='40px' id='homeTelephone_td' rowSpan='1'>
                        <div dojoType='unieap.form.TextBox' id='homeTelephone' maxLength='32' width='100%' binding="{name:'homeTelephone'}" inputFilter="{filterRule:/(^[0-9]{3,4}\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)|(^0{0,1}1[0-9]{10}$)/}"></div>
                    </td>
                </tr>
