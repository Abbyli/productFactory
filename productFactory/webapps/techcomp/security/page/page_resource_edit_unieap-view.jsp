...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/page/page_resource_edit_unieap-processor.js?version=20140815183419"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/page/page_resource_edit_unieap-view.js?version=20140815183419"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				page_resource_edit_unieap.page_initEvents&&dojo.hitch(page_resource_edit_unieap,page_resource_edit_unieap.page_initEvents)();
				page_resource_edit_unieap.page_load&&dojo.hitch(page_resource_edit_unieap,page_resource_edit_unieap.page_load)();
