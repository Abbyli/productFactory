...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/application/sysSecApplicationEdit-processor.js?version=20140818140217"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/application/sysSecApplicationEdit-view.js?version=20140818140217"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				sysSecApplicationEdit.page_initEvents&&dojo.hitch(sysSecApplicationEdit,sysSecApplicationEdit.page_initEvents)();
				sysSecApplicationEdit.page_load&&dojo.hitch(sysSecApplicationEdit,sysSecApplicationEdit.page_load)();
