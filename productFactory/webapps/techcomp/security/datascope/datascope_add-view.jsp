...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/datascope/datascope_add-processor.js?version=20141114142206"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/datascope/datascope_add-view.js?version=20141114142206"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				datascope_add.page_initEvents&&dojo.hitch(datascope_add,datascope_add.page_initEvents)();
				datascope_add.page_load&&dojo.hitch(datascope_add,datascope_add.page_load)();
                    ...
                    <tbody>
                        ...
                        <tr height='40px' id='form1_4_tr'>
                            <td align='right' id='dataSourceName_label_td' rowSpan='1'>
                                <label id='dataSourceName_label'>数据源：</label>
                            </td>
                            <td colSpan='6' height='30px' id='dataSourceName_td' rowSpan='1'>
                                <div dojoType='unieap.form.ComboBox' id='dataSource' required='true' width='50%' binding="{markDirty:false,name:'dataSource'}" dataProvider="{store:'dataSourceDS'}" decoder="{displayAttr:'name',valueAttr:'id'}"></div>
                            </td>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr height='60px' id='form1_1_tr'>
                            <td align='right' id='sql_label_td' rowSpan='1'>
                                <label id='sql_label'>SQL：</label>
                            </td>
                            <td colSpan='6' height='59px' id='sql_td' rowSpan='1'>
