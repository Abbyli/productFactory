...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/station/stationAdd-processor.js?version=20140812172610"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/station/stationAdd-view.js?version=20140812172610"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				stationAdd.page_initEvents&&dojo.hitch(stationAdd,stationAdd.page_initEvents)();
				stationAdd.page_load&&dojo.hitch(stationAdd,stationAdd.page_load)();
                ...
                <table id='form1_tableLayout' width='100%' style='table-layout:fixed;'>
                    ...
                    <tbody>
                        ...
                        <tr height='59px' id='form1_2_tr'>
                            ...
                            <td colSpan='2' id='description_td' rowSpan='1' valign='bottom'>
