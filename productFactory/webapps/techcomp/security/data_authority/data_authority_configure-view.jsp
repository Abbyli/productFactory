...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/data_authority/data_authority_configure-processor.js?version=20141230141922"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/data_authority/data_authority_configure-view.js?version=20141230141922"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				data_authority_configure.page_initEvents&&dojo.hitch(data_authority_configure,data_authority_configure.page_initEvents)();
				data_authority_configure.page_load&&dojo.hitch(data_authority_configure,data_authority_configure.page_load)();
    ...
    <div dojoType='unieap.xdialog.Dialog' height='530px' id='addXDialog' title='配置' url='<%=path%>/techcomp/security/data_authority_data_authority_datascope_group_entry.action' width='720px'>
    </div>
    <div dojoType='unieap.layout.BorderContainer' design='headline' id='borderLayout1' showTitleBar='false'>
        <div dojoType='unieap.layout.BorderPane' id='borderPane0' region='left' showTitleBar='false' splitLine='false' width='25%'>
            <div dojoType='unieap.form.Button' height='39px' id='button3' label='数据权限信息' width='100%'></div>
            <div dojoType='unieap.tree.Tree' id='tree1' binding="{id:'id',label:'name',query:{name:'id',relation:'=',value:null},store:'sysSecDataAuthority'}"></div>
        </div>
        <div dojoType='unieap.layout.BorderPane' id='borderPane1' region='center' showTitleBar='false' splitLine='false'>
            <div dojoType='unieap.layout.BorderContainer' design='headline' id='borderLayout2' showTitleBar='false'>
                    ...
                    <table height='35px' id='ToolBar1' width='100%' style='table-layout:fixed;'>
                        ...
                        <tbody>
                            <tr height='25px'>
                                ...
                                <td>
                                    <div dojoType='unieap.form.Button' height='25px' id='button1' label='配置' width='90px'></div>
                                </td>
                                <td>
                                    <div dojoType='unieap.form.Button' height='25px' id='button2' label='删除' width='90px'></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div dojoType='unieap.layout.BorderPane' id='borderPane3' region='center' showTitleBar='false' splitLine='false'>
                    <div dojoType='unieap.form.Form' id='form1' binding="{store:'sysSecDataScopeGroup1'}">
                    ...
                    <div dojoType='unieap.form.InlineEditBox' disabled='true' height='10px' id='inlineEditBox1' width='98%' style='margin-left :1%;margin-right:1%;'></div>
                    ...
                    <div dojoType='unieap.layout.TitlePane' flexible='false' id='grid1_titlePane_qResult' title='配置权限列表'>
                        <div dojoType='unieap.xgrid.Grid' height='285px' id='grid1' binding="{store:'sysSecDataScopeGroup',rpc:data_authority_configure.grid1_binding_rpc}" selection="{selectType:'multiple'}" views="{rowBar:true,rowNumber:true}">
