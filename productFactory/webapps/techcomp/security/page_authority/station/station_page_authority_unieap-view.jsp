...
<html>
	<head>
		...
		<script type="text/javascript" scope="processor" src="<%=path%>/techcomp/security/page_authority/station/station_page_authority_unieap-processor.js?version=20141231164747"></script>
		
		<script type="text/javascript" scope="view" src="<%=path%>/techcomp/security/page_authority/station/station_page_authority_unieap-view.js?version=20141231164747"></script>
		...
		<script type="text/javascript">
			if(!window["dataCenter"]){
	 		...
	 		dojo.addOnLoad(function(){
				...
				station_page_authority_unieap.page_initEvents&&dojo.hitch(station_page_authority_unieap,station_page_authority_unieap.page_initEvents)();
				station_page_authority_unieap.page_load&&dojo.hitch(station_page_authority_unieap,station_page_authority_unieap.page_load)();
    ...
    <div dojoType='unieap.layout.BorderContainer' design='sidebar' height='99%' id='borderLayout2' showTitleBar='false'>
        ...
        <div dojoType='unieap.layout.BorderPane' id='borderPane3' region='left' showTitleBar='false' splitLine='false' width='25%'>
            <div dojoType='unieap.layout.BorderContainer' design='headline' id='borderLayout3' showTitleBar='false'>
                ...
                <div dojoType='unieap.layout.BorderPane' id='borderPane6' region='center' showTitleBar='false' splitLine='false'>
                    <div dojoType='unieap.xgrid.Grid' height='100%' id='grid1' binding="{store:'sysSecStation'}" rows="{defaultHeaderHeight:'30',defaultRowHeight:'30'}" selection="{selectType:'single',onAfterSelect:station_page_authority_unieap.grid1_selection_onAfterSelect}"
                    views="{rowBar:true,rowNumber:false,onCellClick:station_page_authority_unieap.grid1_views_onCellClick}">
                        <header>
                            <row>
        ...
        <div dojoType='unieap.layout.BorderPane' id='borderPane4' region='center' showTitleBar='false' splitLine='false'>
            <div dojoType='unieap.tree.Tree' id='tree2' binding="{id:'id',label:'name',parent:'appId',query:{name:'appId',relation:'=',value:null},store:'sysSecPage'}" checkLogic="{model:'cascade'}"></div>
        </div>
    </div>
</s:i18n>
    </security:auth>
