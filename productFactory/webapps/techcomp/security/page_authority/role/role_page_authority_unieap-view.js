...
unieap.define("role_page_authority_unieap", function () {

    dojo.addOnLoad(function () {

    });

    dojo.declare("_security.page_authority.role.role_page_authority_unieap.View", unieap.view.View, {
        ...
        create: function () {
            ...
            this.processor = new _security.page_authority.role.role_page_authority_unieap.Processor(this);
    ...
    function grid1_selection_onAfterSelect(inRowIndex) {
        ...
        //alert(roleId)
        view.processor.getAuthorizedPages(roleId, "0");
    }
    ...
    var view = new _security.page_authority.role.role_page_authority_unieap.View();
    view.init();
