...
<style>
	...
	@import "<%=path%>/techcomp/ria/unieap/themes/blue/css/unieap.css";
	@import "<%=path%>/techcomp/ria/base/themes/common.css";
	@import "<%=path%>/techcomp/ria/unieapx/themes/css/query.css";
	...
	@import "<%=path%>/techcomp/ria/unieapx/themes/blue/css/layout-navigatorcontainer.css";
	@import "<%=path%>/techcomp/ria/unieapx/themes/blue/css/form-quicksearch.css";
	@import "<%=path%>/techcomp/ria/unieapx/themes/blue/css/record-script.css";
	body{
		margin : 0px;
		visibility : hidden;
	}
