...
//					this.waitRender=false;
	...
	_enableTooltip:function(e){
		...
		//	paddingRight=parseInt(dojo.getComputedStyle(cellNode.childNodes[0]).paddingRight);//火狐下tooltip报脚本错误问题 见U_EAP00008619
			var showToolTip = dojo.contentBox(this._globalSpan).w>dojo.contentBox(cellNode).w;
	...
	_onMousedown: function(e) {
		...
		if(e.ctrlKey){
			rows.updateHighlightRow(Number(e.rowIndex),false);
		}else{
			rows.updateHighlightRow(Number(e.rowIndex),true);
		}
