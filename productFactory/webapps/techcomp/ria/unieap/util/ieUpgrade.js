...
(function() {
	if (getCookie("popDiv") == null || getCookie("popDiv") == true) {
		...
		if (Sys.ie && Sys.ie < 8) {
			var popDiv = "<div id='popDiv' style='background-color:#FFFFFF;font-size:12px;width:950px;height:100px;text-align:center;'>"
					+ "<hr style='margin:-6px 1px 0 1px;;height:5px;border-top:5px solid #F6DC70;'></hr>"
					+ "<div style='float:left; width:910px;height:60px;vartical-align:middle;padding:3px 20px 3px 55px;text-align:center;'>"
					+ "<span>友情提示：您当前使用的浏览器是IE"+Sys.ie+"，为了加快浏览速度，建议您升级到&nbsp;&nbsp;</span>"
//					+ "<span>" + RIA_I18N.util.ie.isIE + Sys.ie + RIA_I18N.util.ie.toIE8
					+ "<a href='#' onClick='upgrade(event)'>IE8浏览器</a>。" 
					+ "</div>"
					+ "<div style='float:right;text-align:center;width:20px;height:30px;padding:5px 10px 0 0;'>"
					+ "<img src='"
					+ unieap.WEB_APP_NAME
					+ "/techcomp/ria/unieap/themes/blue/images/grid/filter/cancel.gif' onClick='closePopDiv()' style='cursor:pointer;'></img>"
					+ "</div>" + "</div>";
...
var ie8 = {
	label : "IE8升级程序",
//	label : RIA_I18N.util.ie.programForIE8,
