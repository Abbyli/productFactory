dojo.provide("unieapx.widget.drag.OverDropMode");

dojo.require("unieapx.widget.drag.AreaManager");

dojo.declare(
	"unieapx.widget.drag.OverDropMode",
	null,
{
	// summary:
	...
	constructor: function(){
		//console.log("unieap.widget.drag.OverDropMode ::: constructor");
		this._dragHandler = [
			dojo.connect(unieapx.widget.drag.areaManager(), "onDragEnter", function(coords, size){
				var m = unieapx.widget.drag.areaManager();
	...
	addArea: function(/*Array*/areas, /*Object*/object){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: addArea");
	...
	updateAreas: function(/*Array*/areaList){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: updateAreas");
	...
	initItems: function(/*Object*/area){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: initItems");
	...
	refreshItems: function(/*Object*/area, /*Integer*/indexItem, /*Object*/size, /*Boolean*/added){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: refreshItems", area, indexItem, size, added);
		if(indexItem == -1){
			return;
		}
	...
	getDragPoint: function(/*Object*/coords, /*Object*/size, /*Object*/mousePosition){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: getDragPoint");
		return {			// Object
			'x': mousePosition.x,
			'y': mousePosition.y
			}
	...
	getTargetArea: function(/*Array*/areaList, /*Object*/ coords, /*integer*/currentIndexArea ){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: getTargetArea");
		var index = 0;
		var x = coords.x;
		var y = coords.y;
	...
	_checkInterval: function(/*Array*/areaList, /*Integer*/index, /*Coord*/x, /*Coord*/y){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: _checkInterval");
	...
	getDropIndex: function(/*Object*/ targetArea, /*Object*/ coords){
		...
		//console.log("unieap.widget.drag.OverDropMode ::: getDropIndex");
...
(function(){
	unieapx.widget.drag.areaManager()._dropMode = new unieapx.widget.drag.OverDropMode();
}());
