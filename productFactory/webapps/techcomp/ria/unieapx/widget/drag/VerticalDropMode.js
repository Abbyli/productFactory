dojo.provide("unieapx.widget.drag.VerticalDropMode");
dojo.require("unieapx.widget.drag.AreaManager");

dojo.declare(
	"unieapx.widget.drag.VerticalDropMode",
	null,
{
	// summary:
	...
	addArea: function(/*Array*/areas, /*Object*/object){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: addArea");
	...
	updateAreas: function(/*Array*/areaList){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: initAreas");
	...
	_updateArea : function(/*Object*/area){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode  ::: _updateArea");
	...
	initItems: function(/*Object*/area){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: initItems");
	...
	refreshItems: function(/*Object*/area, /*Integer*/indexItem, /*Object*/size, /*Boolean*/added){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: refreshItems");
		if(indexItem == -1){
			return;
		}
	...
	getDragPoint: function(/*Object*/coords, /*Object*/size, /*Object*/mousePosition){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: getDragPoint");
		var y = coords.y;
		if(this._oldYPoint){
	...
	getTargetArea: function(/*Array*/areaList, /*Object*/ coords, /*integer*/currentIndexArea ){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: getTargetArea");
		var index = 0;
		var x = coords.x;
	...
	getDropIndex: function(/*Object*/ targetArea, /*Object*/ coords){
		...
		//console.log("acap.widget.drag.dropMode.VerticalDropMode ::: getDropIndex");
...
//------------
(function(){
	unieapx.widget.drag.areaManager()._dropMode = new unieapx.widget.drag.VerticalDropMode();
}());