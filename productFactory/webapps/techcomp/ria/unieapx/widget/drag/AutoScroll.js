dojo.provide("unieapx.widget.drag.AutoScroll");

dojo.declare(
	"unieapx.widget.drag.AutoScroll",
	null,
{
	// summary:
	...
	constructor: function(){
		//console.log("unieap.widget.drag.AutoScroll ::: constructor ");
	...
	init: function(){
		//console.log("unieap.widget.drag.AutoScroll ::: init ");
	...
	getViewport:function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: getViewport ");
	...
	setAutoScrollNode: function(/*Node*/node){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: setAutoScrollNode ");
		this._node = node;
	},
	...
	setAutoScrollMaxPage: function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: setAutoScrollMaxPage ");
	...
	checkAutoScroll: function(/*Event*/e){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: checkAutoScroll");
	...
	_autoScrollDown: function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: _autoScrollDown ");
		if(this._timer){
	...
	_autoScrollUp: function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: _autoScrollUp ");
		if(this._timer){
			clearTimeout(this._timer);
		}
	...
	_autoScrollRight: function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: _autoScrollRight ");
		if(this._timer){
			clearTimeout(this._timer);
		}
	...
	_autoScrollLeft: function(/*Event*/e){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: _autoScrollLeft ");
		if(this._timer){
			clearTimeout(this._timer);
		}
	...
	stopAutoScroll: function(){
		...
		//console.log("unieap.widget.drag.AutoScroll ::: stopAutoScroll ");
		if(this._timer){
			clearTimeout(this._timer);
		}
	...
	destroy: function(){
		//console.log("unieap.widget.drag.AutoScroll ::: destroy ");
		dojo.disconnect(this.resizeHandler);
	}
});

unieapx.widget.drag.autoScroll = null;
(function(){
	unieapx.widget.drag.autoScroll = new unieapx.widget.drag.AutoScroll();
}());
